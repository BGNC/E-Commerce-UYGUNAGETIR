                ...
                <div class="menu-nav">
                    ...
                    <nav>
                        <ul>
                            ...
                            $kategorisql    =   mysql_query("SELECT * FROM kategori ORDER BY kategori_adi ASC");
                            while($kategorigetir=mysql_fetch_array($kategorisql))
                            { 
                            ...
                            <li>
                                ...
                                <ul>
                                    <?php
                                    $sorgu=mysql_query("SELECT * FROM altkategori where kategori_id=$kategori_id ORDER BY altkategori_adi ASC");
